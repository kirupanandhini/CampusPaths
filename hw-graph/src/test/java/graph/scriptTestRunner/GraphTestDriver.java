 ...
 **/
public class GraphTestDriver<E, V> {
    ...
    private void addNode(String graphName, String nodeName) {
        ...
        graph.insertNode(new Graph.Node<String>(nodeName));
    ...
    private void listNodes(String graphName) {
          Graph<String, String> graph = graphs.get(graphName);
          Set<String> nodeStrings = new TreeSet<String>();
          String listOfNodes= "";
          for (Graph.Node<String> node : graph.listNodes()) {
              nodeStrings.add(node.getNodeLabel());
          }

          for (String n : nodeStrings) {
              listOfNodes += " "+ n;
          }
          output.println(graphName + " contains:" + listOfNodes);
    }
    ...
    private void listChildren(String graphName, String parentName) {
        ...
        List<Graph.Edge<String, String>> x = graph.listEdges(new Graph.Node<String>(parentName));
        for (Graph.Edge<String, String> edge : x) {
            childrenStrings.add(" "+ edge.getChild().getNodeLabel() + "(" +
                    edge.getEdgeLabel() + ")");
        }
        Collections.sort(childrenStrings);
        for (String str : childrenStrings) {
            listOfNodes += str;
        }
