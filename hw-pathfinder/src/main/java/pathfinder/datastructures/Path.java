...
public class Path<E> implements Iterable<Path<E>.Segment>, Comparable<Path<E>> {
    ...
    public int compareTo(Path<E> other) {
        int compare = Double.compare(this.getCost(), other.getCost());
        return compare;
    }
     ...
     */
    public class Segment implements Comparable<Path<E>.Segment> {
        ...
        public int compareTo(Path<E>.Segment other) {
            int compare = Double.compare(this.getCost(), other.getCost());
            return compare;
        }
